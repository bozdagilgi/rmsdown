...
author: "Global Data Service - Statistics, Data Science and Surveys Section"
date: "2024-10-10"
output: 
...
table_pop_group_1 %>%
  kable(caption = "RMS South Sudan 2023 - Indicators for Population Group 1") %>%
...
# Table for Population Group 1
table_pop_group_2 %>%
  kable(caption = "RMS South Sudan 2023 - Indicators for Population Group 2") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"),
                full_width = FALSE, 
                position = "center", 
                font_size = 10)
